...
const ModalsLayout = (
    ...
    return (
        <div className="fixed inset-0 z-10 bg-black bg-opacity-50 flex justify-end items-right">
            <div
                className={`bg-white p-6 py-12 rounded-lg rounded-tr-[0] rounded-br-[0] max-w-md transform transition-transform duration-300 
